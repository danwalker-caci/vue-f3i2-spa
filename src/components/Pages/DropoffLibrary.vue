...
export default {
  ...
  mounted: function() {
    ...
    if (this.isAFRL) {
      this.recipientOptions = []
      this.recipientOptions.push({ kind: 'Group', title: 'Workplan Managers', component: 'PeoplePicker', id: 'WorkplanManagers', user: this.currentUser })
    }
    if (this.isSubcontractor) {
      this.recipientOptions = []
      this.recipientOptions.push({ kind: 'Company', title: this.currentUser[0].Company, id: 'Company', component: 'PeoplePicker', user: this.currentUser }, { kind: 'Group', title: 'Workplan Managers', component: 'PeoplePicker', id: 'WorkplanManagers', user: this.currentUser })
    }
    let url =

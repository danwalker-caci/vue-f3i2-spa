      ...
      <div class="collapse navbar-collapse justify-content-end">
        <b-navbar-nav class="ml-auto hidden-xs">
          ...
          <b-nav-item-dropdown id="SettingsMenu" right no-caret menu-class="animated bounceInDown">
            ...
            <b-dropdown-item v-if="isDeveloper" href="#" @click="gitRdone('addanapp.aspx')">
              <div class="row">
                <font-awesome-icon far icon="plus-square" class="icon"></font-awesome-icon>
                <span>Add an app</span>
              </div>
            </b-dropdown-item>
            <b-dropdown-item v-if="isDeveloper" href="#" @click="gitRdone('DesignSite.aspx')">
              <div class="row">
                <font-awesome-icon fas icon="pencil-alt" class="icon"></font-awesome-icon>
                <span>Design Manager</span>
              </div>
            </b-dropdown-item>
            <b-dropdown-item v-if="isDeveloper" href="#" @click="gitRdone('viewlsts.aspx')">
              <div class="row">
                <font-awesome-icon fas icon="box-open" class="icon"></font-awesome-icon>
                <span>Site contents</span>
              </div>
            </b-dropdown-item>
            <b-dropdown-item v-if="isDeveloper" href="#" @click="gitRdone('settings.aspx')">
              <div class="row">
            ...
            <b-dropdown-item href="#" @click="gitRdone('SignOut.aspx')">
              <div class="row">
...
export default {
  ...
  methods: {
    ...
    gitRdone: function(page) {
      let url = SPCI.webServerRelativeUrl + '/_layouts/15/' + page
      window.location = url
    },
